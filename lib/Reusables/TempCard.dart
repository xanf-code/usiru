      ...
      child: Container(
        ...
        child: PageView(
          ...
          children: [
            DelayedDisplay(
              child: TempBackCard(
                temp: data==null? 0: data[1]['temp']['day'],
            ...
            DelayedDisplay(
              child: TempBackCard(
                temp: data==null? 0: data[2]['temp']['day'],
                ...
                y1: hour==null? 0: hour[1]['temp'].toDouble(),//6:00am
                y2: hour==null? 0: hour[7]['temp'].toDouble(),//9:00am
                y3: hour==null? 0: hour[16]['temp'].toDouble(),//12pm
            ...
            DelayedDisplay(
              child: TempBackCard(
                temp: data==null? 0: data[3]['temp']['day'],
            ...
            DelayedDisplay(
              child: TempBackCard(
                temp: data==null? 0: data[4]['temp']['day'],
            ...
            DelayedDisplay(
              child: TempBackCard(
                temp: data==null? 0: data[5]['temp']['day'],
            ...
            DelayedDisplay(
              child: TempBackCard(
                temp: data==null? 0: data[6]['temp']['day'],
            ...
            DelayedDisplay(
              child: TempBackCard(
                temp: data==null? 0: data[7]['temp']['day'],
